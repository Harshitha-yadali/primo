  ...
  private readonly plans: SubscriptionPlan[] = [
    {
      ...
      guidedBuilds: 5,
      linkedinOptimizations: 1, // New field
    ...
    },
    {
      ...
      guidedBuilds: 2,
      linkedinOptimizations: 0, // New field
  ...
  async getUserSubscription(userId: string): Promise<Subscription | null> {
    try {
      ...
      return {
        ...
        linkedinOptimizationsUsed: data.linkedin_optimizations_used, // New field
        linkedinOptimizationsTotal: data.linkedin_optimizations_total // New field
      };
    } catch (error) {
